...
> = {
  ...
  RESTAURANT_RECOMMENDATION_PENDING: { label: "장소 추천중", variant: "diningRestaurant" },
  RESTAURANT_VOTING: { label: "장소 투표", variant: "diningRestaurant" },
  CONFIRMED: { label: "회식 확정", variant: "confirmed" },
  RECEIPT_VERIFYING: { label: "영수증 검증중", variant: "diningRestaurant" },
  RECEIPT_APPROVED: { label: "영수증 승인", variant: "confirmed" },
  RECEIPT_REJECTED: { label: "영수증 거부", variant: "diningAttendance" },
